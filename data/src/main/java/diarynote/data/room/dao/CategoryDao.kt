...
interface CategoryDao {
    ...
    @Transaction
    @Query("SELECT * FROM UserEntity INNER JOIN CategoryEntity ON CategoryEntity.user_id = UserEntity.id WHERE id LIKE :id")
    fun getUserWithCategoryAndNotes(id: Int): Single<UserWithCategoriesAndNotes>
