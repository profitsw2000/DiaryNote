...
const val SETTINGS_ACCOUNT_ID = 1
const val SETTINGS_THEME_ID = 2
const val SETTINGS_LANGUAGE_ID = 3
const val SETTINGS_GENERAL_ID = 4
const val SETTINGS_HELP_ID = 5
const val SETTINGS_ABOUT_ID = 6

const val ACCOUNT_CHANGE_PASSWORD_ID = 7
const val ACCOUNT_PROFILE_PHOTO_ID = 8
...
const val LAST_ENTRANCE_TIME_KEY = "last_entrance"
const val TITLE_SEARCH_PRIORITY_KEY = "title_priority"
const val TEXT_SEARCH_PRIORITY_KEY = "text_priority"
const val TAGS_SEARCH_PRIORITY_KEY = "tags_priority"
const val HOUR_INACTIVE_INDEX = 0
const val DAY_INACTIVE_INDEX = 1
const val WEEK_INACTIVE_INDEX = 2
const val MONTH_INACTIVE_INDEX = 3